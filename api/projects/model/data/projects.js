module.exports = [
  {
    ...
    link: "https://github.com/Michaelpalacce/personal-website-vue.git",
    text:
      "Nothing to say really! You are looking at it. Uses NodeJS as a backend, VueJs as the front-end." +
      "<br/><br/>" +
  ...
  },
  {
    ...
    badges: [
      {
        badge: "https://img.shields.io/maintenance/yes/2026",
        link: "https://github.com/Michaelpalacce/garden.git",
      },
    ],
    links: [
      {
      ...
      {
        icon: "/imgs/github-icon.svg",
        link: "https://github.com/Michaelpalacce/garden",
      },
    ],
    link: "https://garden.sgenov.dev",
    text: "Powered by Quartz and my Obsidian notes.<br/><br/>Used for blogging and 'Studying in public'.",
  ...
  },
  {
    ...
    badges: [
      {
        ...
        badge:
          "https://github.com/Michaelpalacce/EventRequest/workflows/linux-12.x/badge.svg",
      },
      {
        link: "https://github.com/Michaelpalacce/EventRequest/actions?query=workflow%3Alinux-14.x",
        badge:
          "https://github.com/Michaelpalacce/EventRequest/workflows/linux-14.x/badge.svg",
      },
      {
        link: "https://github.com/Michaelpalacce/EventRequest/actions?query=workflow%3Alinux-16.x",
        badge:
          "https://github.com/Michaelpalacce/EventRequest/workflows/linux-16.x/badge.svg",
      },
      {
        link: "https://github.com/Michaelpalacce/EventRequest/actions?query=workflow%3Alinux-18.x",
        badge:
          "https://github.com/Michaelpalacce/EventRequest/workflows/linux-18.x/badge.svg",
      },
      {
        link: "https://github.com/Michaelpalacce/EventRequest/actions?query=workflow%3Awindows-12.x",
        badge:
          "https://github.com/Michaelpalacce/EventRequest/workflows/windows-12.x/badge.svg",
      },
      {
        link: "https://github.com/Michaelpalacce/EventRequest/actions?query=workflow%3Awindows-14.x",
        badge:
          "https://github.com/Michaelpalacce/EventRequest/workflows/windows-14.x/badge.svg",
      },
      {
        link: "https://github.com/Michaelpalacce/EventRequest/actions?query=workflow%3Awindows-16.x",
        badge:
          "https://github.com/Michaelpalacce/EventRequest/workflows/windows-16.x/badge.svg",
      },
      {
        link: "https://github.com/Michaelpalacce/EventRequest/actions?query=workflow%3Awindows-18.x",
        badge:
          "https://github.com/Michaelpalacce/EventRequest/workflows/windows-18.x/badge.svg",
      },
      {
        ...
        badge:
          "https://app.codacy.com/project/badge/Coverage/3c843dd2bc454f06b10eb60820dc6d1b",
      },
      {
        badge: "https://img.shields.io/maintenance/yes/2026",
    ...
    link: "https://github.com/Michaelpalacce/EventRequest.git",
    text:
      "EventRequest is a zero-dependency, extremely fast and highly customizable web framework built in NodeJS." +
      "<br/><br/>" +
      "It offers a wide array of built in plugins and a wide sort of extendable components. This site is powered by EventRequest!",
    images: ["/imgs/EventRequest-1.svg", "/imgs/EventRequest-2.png"],
  },
  {
    title: "HomeLab",
    technologies: [
  ...
  },
  {
    ...
    link: "https://github.com/Michaelpalacce/Server.git",
    text:
      "This npm module allows you to access your file system in the browser. Allows for a wide variety of operations ( copy, cut, paste, delete, download, etc. ). It also allows for video, text, image and audio streaming." +
      "<br/><br/>" +
  ...
  },
  {
    ...
    text:
      "This npm module allows pagination of the file system. It fetches directories first and then files, allowing you to order the results in a more predictable fashion." +
      "<br/><br/>" +
  ...
  },
  {
    ...
    images: ["/imgs/er_redis_data_server-1.svg"],
  },
  {
    ...
    images: ["/imgs/er_memcached_data_server-1.svg"],
  },
  {
  ...
  },
  {
    ...
    link: "https://github.com/Michaelpalacce/ansible-docker-compose.git",
    text:
      "Ansible Role that installs a specific user-defined version of docker-compose. This role also creates a symlink for you, " +
  ...
  },
  {
    ...
    installCommand:
      "ansible-galaxy install michaelpalacce.kubernetes_preflight",
    technologies: [
      {
        isImg: true,
        content: "/imgs/technologies/ansible-logo.svg",
  ...
  },
  {
    ...
    installCommand:
      "ansible-galaxy install michaelpalacce.kubernetes_master_security",
    technologies: [
      {
        isImg: true,
        content: "/imgs/technologies/ansible-logo.svg",
