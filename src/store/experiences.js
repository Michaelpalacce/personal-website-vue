module.exports	= [
	...
	},
	{
		...
		message: 'Apart from working as a PHP Fullstack developer I also work as a Devops Engineer. I\'ve used technologies like Bamboo, Chef, AWS. Deployed multiple environments to production.<br/><br/>' +
			' One of the projects that has been deployed to production was done by using AWS. I\'ve single handed set-up the entire infrastructure in AWS, configured automatic deployments, builds and testing.' +
